...
async function initialize_page(){
    ...
    let charts = await initialize_display(income_canvas, expenses_canvas, total, total_expenses, total_income, dropdown);
    dropdown.addEventListener("change", ()=>{
        update_chart(charts[0], charts[1], total, total_expenses, total_income, dropdown);
    });
}

async function update_chart(income_chart, expenses_chart, total, total_expenses, total_income, dropdown){
    ...
    set_totals(total, total_expenses, total_income, overview_data);
}
...
async function initialize_display(income_canvas, expenses_canvas, total, total_expenses, total_income, dropdown){
    let overview_data = await fetch_overview(dropdown);
    ...
    console.log(overview_data["income_labels"]);
    console.log(overview_data["income_data"]);
...
function set_totals(total, total_expenses, total_income, overview_data){
